...
export default class DemoListItem extends PureComponent {
    ...
    return (
      <CardItem bordered={true} style={styles.cardItemStyle}>
        <View style={styles.contentViewStyle}>
          <Text style={styles.contentLabelStyle}>
            {strings.openedtime}
          </Text>
...
const styles = StyleSheet.create({
  cardItemStyle: {
    ...
    borderColor: mainTheme.demoSignalBorderColor,
  },
  headerViewStyle: {
    flexDirection: 'row',
    flex: 1,
  ...
  contentPairStyle: {
    flex: 1,
    color: mainTheme.demoSignalItemColor,
    fontWeight: 'bold',
  },
  buyStyle: {
    flex: 1,
